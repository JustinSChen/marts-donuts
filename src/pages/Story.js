...
const Story = () => {
  return (
    <div className="story-page">
      ...
      <p className="left">Returning in 2022, Kork is once again working tirelessly, starting every night at 10 PM to ensure that by 4 AM, our donuts are fresh and ready for you. His dedication continues through the morning, so every bite is as fresh as the first.</p>
    </div>
  );
};
